...
const file_user_proto_rawDesc = "" +
	...
	"\bbirthDay\x18\x04 \x01(\x04R\bbirthDay\"\x1b\n" +
	"\tIdRequest\x12\x0e\n" +
	...
	"\x04data\x18\x02 \x03(\v2\x11.UserInfoResponseR\x04data2\xbb\x02\n" +
	"\n" +
	"UserServer\x12+\n" +
	...
	"\rCheckPassWord\x12\x12.CheckPasswordInfo\x1a\x0e.CheckResponseB\tZ\a.;protob\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 1: UserServer.GetUserList:input_type -> PageInfo
	3, // 2: UserServer.GetUserByMobile:input_type -> MobileRequest
	6, // 3: UserServer.GetUserById:input_type -> IdRequest
	4, // 4: UserServer.CreateUser:input_type -> CreateUserInfo
	5, // 5: UserServer.UpdateUser:input_type -> UpdateUserInfo
	0, // 6: UserServer.CheckPassWord:input_type -> CheckPasswordInfo
	8, // 7: UserServer.GetUserList:output_type -> UserListResponse
	7, // 8: UserServer.GetUserByMobile:output_type -> UserInfoResponse
	7, // 9: UserServer.GetUserById:output_type -> UserInfoResponse
	7, // 10: UserServer.CreateUser:output_type -> UserInfoResponse
	9, // 11: UserServer.UpdateUser:output_type -> google.protobuf.Empty
	1, // 12: UserServer.CheckPassWord:output_type -> CheckResponse
